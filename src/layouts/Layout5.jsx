    ...
    <section className="relative bg-slate-50 py-24 md:py-36 overflow-hidden mt-20" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16" data-aos="fade-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 border border-white/40 text-white font-['Baloo 2',sans-serif] text-sm font-medium mb-6">
            <span className="w-2 h-2 rounded-full bg-accent-light"></span>
            Legal Service
          </div>
          <h2 className="font-['Signika',Helvetica,Arial,Lucida,sans-serif] text-4xl md:text-5xl text-white mb-8 leading-tight">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-lg border border-white/20" data-aos="fade-up" data-aos-delay="200">
          <div className="prose prose-lg max-w-none font-['Baloo 2',sans-serif] text-white leading-relaxed">
            <p className="mb-6">
          ...
          <div className="mt-12 pt-8 border-t border-white/30">
            ...
            <p className="text-center text-white/80 font-['Baloo 2',sans-serif] text-sm mb-8">
              Please contact Gary Addison for more information
            </p>
            <div className="text-center">
              <button className="inline-flex h-16 items-center justify-center gap-3 rounded-2xl bg-navy-500 px-10 text-lg font-['Signika',Helvetica,Arial,Lucida,sans-serif] font-semibold text-white shadow-xl shadow-navy-600/30 hover:shadow-2xl hover:shadow-navy-600/50 transition-all duration-300">
                Contact Us
              </button>
            </div>
          </div>
