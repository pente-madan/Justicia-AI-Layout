      ...
      <div className="flex flex-col lg:flex-row relative min-h-[800px]">
        ...
        <div className="flex-1 p-12 lg:p-24 lg:pt-32 relative z-10 flex flex-col justify-start bg-navy-900">
          <div className="mb-12" data-aos="fade-right">
            <h3 className="font-['Signika',Helvetica,Arial,Lucida,sans-serif] text-2xl text-white mb-2 italic">Operational Integrity</h3>
          ...
          <div className="grid gap-y-10 max-w-2xl">
            {[
              ...
              >
                <div className="absolute left-0 top-1.5 w-[2px] h-4 bg-white opacity-60" />
                <h4 className="font-['Signika',Helvetica,Arial,Lucida,sans-serif] font-bold uppercase tracking-widest text-sm mb-2 text-white">{item.title}</h4>
                <p className="font-['Baloo 2',sans-serif] text-base leading-relaxed text-white/90">{item.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
            <div className="absolute top-[-20%] left-[-20%] w-full h-full bg-accent-500/5 rounded-full blur-[120px]" />
          </div>
        </div>
        ...
        <div className="flex-1 p-12 lg:p-24 lg:pt-32 relative z-10 flex flex-col justify-start bg-white border-t lg:border-t-0 lg:border-l border-slate-100">
          <div className="mb-12" data-aos="fade-left">
            <h3 className="font-['Signika',Helvetica,Arial,Lucida,sans-serif] text-2xl text-navy-900 mb-2 italic">Strategic Recovery</h3>
            <div className="w-20 h-[1px] bg-navy-400" />
          </div>
          ...
          <div className="grid gap-y-10 max-w-2xl">
            {[
              ...
              <div
                ...
                className="group relative pl-8"
              >
                <div className="absolute left-0 top-1.5 w-[2px] h-4 bg-navy-500" />
                <h4 className="font-['Signika',Helvetica,Arial,Lucida,sans-serif] font-bold uppercase tracking-widest text-sm mb-2">{item.title}</h4>
                <p className="font-['Baloo 2',sans-serif] text-base leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
            <div className="absolute bottom-[-20%] right-[-20%] w-full h-full bg-accent-500/10 rounded-full blur-[120px]" />
          </div>
        </div>
      </div>
    </section>
